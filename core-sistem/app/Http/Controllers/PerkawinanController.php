...
class PerkawinanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            return redirect()->route('perkawinan.index', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) )->with('error', 'Pendaftaran Perkawinan Gagal. NIK Telah Terdaftar Sebelumnya.');
        }
        else
        {
            $data = new Perkawinan();
    ...
    public function RiwayatPerkawinan(Request $request)
    {
        ...
        return view('perkawinan.RiwayatPerkawinan',compact("data"));
    }
    ...
    public function EditForm(Request $request)
    {
        ...
        return view('perkawinan.EditForm',compact("data"));
    }
    ...
    public function update(Request $request)
    {
        ...
        if($perkawinan1 == $request->get("nik_calon_suami") || $perkawinan2 == $request->get("nik_calon_istri"))
        {
            return redirect()->route('perkawinan.index', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) )->with('error', 'Ubah Data Pendaftaran Perkawinan Gagal. NIK Telah Terdaftar Sebelumnya.');
        }
        else
        {
            ...
            return redirect()->route('perkawinan.index', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) )->with('status', 'Ubah Data Pendaftaran Perkawinan Berhasil');
        }
    }
