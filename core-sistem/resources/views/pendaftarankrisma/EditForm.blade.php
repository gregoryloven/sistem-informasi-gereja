<form role="form" method='POST' action="{{ url('pendaftarankrisma/'.$data->id )}}" enctype="multipart/form-data">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Ubah Pendaftaran Krisma</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <img id="output3" src="{{asset('file_sertifikat/surat_pengantar/'.$data->surat_pengantar)}}" width="80px" height="80px">
            </div>
            @endif
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <img id="output2" src="{{asset('file_sertifikat/sertifikat_komuni/'.$data->sertifikat_komuni)}}" width="80px" height="80px">
            </div>
        </div>
    </div>
