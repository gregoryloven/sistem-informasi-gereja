                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td st>
                            ...
                            <form action="/validasiAdmin/declinekomuni" class="ml-2" method="post">
                                @csrf
                                <input type="text" name="id" class="d-none" value="{{$d->id}}">
                    ...
                    <div class="modal fade" id="modal{{$d->id}}" tabindex="-1" role="basic" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <form role="form" method="POST" action="{{ url('validasiAdmin/declinekomuni') }}" enctype="multipart/form-data">
                                    @csrf
            ...
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    ...
                    <div class="modal fade" id="modal{{$da->riwayatID}}" tabindex="-1" role="basic" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form role="form" method="POST" action="{{ url('validasiAdmin/pembatalankomuni') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
