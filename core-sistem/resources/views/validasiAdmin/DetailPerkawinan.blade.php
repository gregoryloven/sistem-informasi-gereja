...
@section('title')
    Detail Formulir Pendaftaran Sakramen Perkawinan
@endsection

@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 mt-4">Detail Formulir Pendaftaran Sakramen Perkawinan</h1>
            ...
            <table class="table table-bordered">
                ...
                @foreach($data as $d)
                    ...
                    @if($d->agama_calon_suami=="Katolik" || $d->agama_calon_istri=="Katolik")
                        ...
                        <td>@if(isset($d->sertifikat_krisma_calon_istri))<a href="#modalPopUp5{{$d->id}}" data-toggle="modal"><img src="{{asset('file_perkawinan/sertifikat_krisma/'.$d->sertifikat_krisma_calon_istri)}}" height='80px'/>@endif</td>
                    @endif
                    </tr>
                    <tr>
