                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td st >
                                ...
                                @elseif($d->statusRiwayat == 'Dibatalkan') 
                                <div class="alert alert-danger" role="alert">
                                    {{$d->statusRiwayat}}
                                </div>
                            ...
                            <td st>
                                @if($d->statusRiwayat == "Disetujui Paroki")
                                <a href="#modal{{$d->riwayatID}}" data-toggle="modal" class="btn btn-xs btn-flat btn-danger">Batal</a>
                                @endif
                            </td>
                        </tr>
                        <!-- EDIT WITH MODAL -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form role="form" method="POST" action="{{ url('validasiAdmin/pembatalankrismasetempat') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h4 class="modal-title">Pembatalan Krisma Setempat</h4>
                                        </div>
                                        <div class="modal-body">
                                            @csrf
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form role="form" method="POST" action="{{ url('validasiAdmin/pembatalankrismalintas') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h4 class="modal-title">Pembatalan Krisma Lintas</h4>
                                        </div>
                                        <div class="modal-body">
                                            @csrf
                                            <label>Alasan Pembatalan:</label>
