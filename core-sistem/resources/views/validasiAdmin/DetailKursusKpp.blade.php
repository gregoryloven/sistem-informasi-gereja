...
@section('title')
    Detail Peserta Kursus Persiapan Perkawinan
@endsection

@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Detail Peserta Kursus Persiapan Perkawinan</h1>
...
<div style="display:none" class="alert alert-success">
    Status Pendaftar Kursus Persiapan Perkawinan Berhasil Diubah
</div>
...
function CekLulus(lulus)
{
    ...
    $.ajax({
    type:'POST',
    url:'{{ route('validasiAdmin.LulusKursusKpp', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) ) }}',
