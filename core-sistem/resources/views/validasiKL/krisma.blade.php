...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Validasi Krisma - Lingkungan {{$lingkungan}}</h1>
@if(session('status'))
                    ...
                    <div class="modal fade" id="modal{{$d->id}}" tabindex="-1" role="basic" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <form role="form" method="POST" action="{{ url('validasiKL/declinekrisma') }}" enctype="multipart/form-data">
                                    @csrf
