...
<svg width="35" height="35" viewBox="0 0 348 512" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    Pendaftaran Sakramen Baptis Dewasa
</h1>
@if(session('status'))
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header py-3">
                Formulir Pendaftaran Sakramen Baptis Dewasa
            </div>
            <div class="card-body">
            <form id="formIndividu" class="mb-2" method="post" action="/baptisdewasa" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id='surat_pernyataan' name='surat_pernyataan' placeholder="Surat Pernyataan" onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])" required>
