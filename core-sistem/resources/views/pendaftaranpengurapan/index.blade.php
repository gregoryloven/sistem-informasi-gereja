...
@section('title')
    Pendaftaran Pengurapan Orang Sakit
@endsection
...
<div class="row mb-4 mt-4">
    ...
    <div class="card shadow">
            <div class="card-header py-3">
                Formulir Pendaftaran Pengurapan Orang Sakit
            </div>
            <div class="card-body">
            ...
            @else
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="keterangan" id="exampleFormControlTextarea1" placeholder="Keterangan" rows="3" required></textarea>
                </div>
                <div class="alert alert-info" role="alert">
                   Jika sudah mendaftar, silahkan lihat status pada "Riwayat Pendaftaran"
                </div>
                            ...
                            <div class="modal fade" id="modal{{$d->id}}" tabindex="-1" role="basic" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content" >
                                        <form role="form" method="POST" action="{{ url('pendaftaranpengurapan/Pembatalan') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                <h4 class="modal-title">Pembatalan Pengurapan</h4>
                                            </div>
...
function detail(id)
{
  $.ajax({
    type:'POST',
    url:'{{ route('pendaftaranpengurapan.detail', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) ) }}',
