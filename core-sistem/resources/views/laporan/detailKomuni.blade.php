...
@section('title')
    Detail Laporan Penolakan & Pembatalan Sakramen Komuni Pertama
@endsection

@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Detail Laporan Penolakan & Pembatalan Sakramen Komuni Pertama</h1>
@if(session('status'))
