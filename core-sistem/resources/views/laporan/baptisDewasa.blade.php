...
@section('title')
    Laporan Sakramen Baptis Dewasa
@endsection

@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Laporan Sakramen Baptis Dewasa</h1>
@if(session('status'))
...
<form role="form" method="GET" action="/laporan/baptisdewasa">
<div class="row">
    <div class="col-md-12">
        <div class="box">
    @csrf
            ...
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($array3[$idx]!=0)
                            <br><a href= "{{ url('laporanBaptis/detaildewasa/'.$d->id) }}" class="btn btn-xs btn-flat btn-info">Lihat Detail</a>
                        @endif
                        </td>
                    </tr>
                    @endforeach
