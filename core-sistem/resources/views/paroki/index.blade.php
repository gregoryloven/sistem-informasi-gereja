...
<div class="modal fade" id="modalCreate" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" >
            <form role="form" method="POST" action="{{ url('parokis') }}" enctype="multipart/form-data">
                @csrf
...
function EditForm(id)
{
  $.ajax({
    type:'POST',
    url:'{{ route('parokis.EditForm', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) ) }}',
