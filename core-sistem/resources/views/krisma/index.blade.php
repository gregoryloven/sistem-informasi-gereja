...
@endif
<a href="#modalCreate" data-toggle='modal' class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah Krisma</a><br><br>

<!-- CREATE WITH MODAL -->
<div class="modal fade" id="modalCreate" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" >
            <form role="form" method="POST" action="{{ url('krismas') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id='jadwal' name='jadwal' placeholder="Tanggal Krisma" required>
                        </div>
                    <div class="form-group">
                        <label >Status</label>
