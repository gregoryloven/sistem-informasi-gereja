...
<div class="row mb-4 mt-4">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <form id="formSetempat" class="mb-2" method="POST" action="/krisma/InputFormSetempat" enctype="multipart/form-data">
            @csrf   
                <div class="form-group">
            ...
            <form id="formLintas" class="mb-2" method="POST" action="/krisma/InputFormLintas" enctype="multipart/form-data">
            @csrf   
                <div class="form-group">
                    <label >Nama Lengkap Penerima Krisma</label>
                    <input type="text" class="form-control" id='nama_lengkap' name='nama_lengkap' placeholder="Nama Lengkap" required>
