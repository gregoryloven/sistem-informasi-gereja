                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td st>
                                ...
                                @endif
                                <!-- @if ($d->status == 'Selesai')
                                    <form role="form" method="GET" action="{{ url('/sertifikat/komunipertama') }}">
                        ...
                        <div class="modal fade" id="modal{{$d->id}}" tabindex="-1" role="basic" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content" >
                                    <form role="form" method="POST" action="{{ url('pendaftarankomuni/Pembatalan') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h4 class="modal-title">Pembatalan Komuni Pertama</h4>
                                        </div>
...
function EditForm(id)
{
  $.ajax({
    type:'POST',
    url:'{{ route('pendaftarankomuni.EditForm', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) ) }}',
