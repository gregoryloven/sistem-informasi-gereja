<form role="form" method='POST' method="post" action="/reservasimisa" enctype="multipart/form-data">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Pemesanan Tiket Misa</h4>
    </div>
