...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Validasi Pendaftaran Umat Baru - KBG {{$kbg2}}</h1>
@if(session('status'))
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td st>
                            ...
                            <form action="/validasiKbg/acceptumatbaru" method="post">
                                @csrf
                                <input type="text" name="id" class="d-none" value="{{$d->id}}">
                                <button class="btn btn-success" type="submit">Terima</button>
                            </form>
                            <form action="/validasiKbg/declineumatbaru" class="mt-1" method="post">
                                @csrf
                                <input type="text" name="id" class="d-none" value="{{$d->id}}">
                    ...
                    <div class="modal fade" id="modal{{$d->id}}" tabindex="-1" role="basic" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <form role="form" method="POST" action="{{ url('validasiKbg/declineumatbaru') }}" enctype="multipart/form-data">
                                    @csrf
