...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Validasi Komuni Pertama - KBG {{$kbg}}</h1>
@if(session('status'))
                ...
                <tbody>
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td st >
                            ...
                            <form action="/validasiKbg/declinekomuni" class="ml-2" method="post">
                                @csrf
                                <input type="text" name="id" class="d-none" value="{{$d->id}}">
                    ...
                    <div class="modal fade" id="modal{{$d->id}}" tabindex="-1" role="basic" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <form role="form" method="POST" action="{{ url('validasiKbg/declinekomuni') }}" enctype="multipart/form-data">
                                    @csrf
