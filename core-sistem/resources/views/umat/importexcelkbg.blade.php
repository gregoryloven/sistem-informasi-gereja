    ...
    <div class="modal-dialog">
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <p>Upload file data umat yang akan diimport pada database. Harap Menggunakan format template yang sudah disediakan. <br> Klik <a href="{{url('/umat/DownloadExcelKbg')}}">Disini</a> Untuk Mendonwload Template Excel</p>
