<form role="form" method='POST' action="{{ url('komunipertama/'.$data->id )}}" enctype="multipart/form-data">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Edit Pendaftaran Komuni Pertama</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{$data->lingkungan}}" class="form-control" id='lingkungan' name='lingkungan' placeholder="Lingkungan" required>
            </div>       
            <div class="form-group">
                <label >KBG</label>
                <input type="text" value="{{$data->kbg}}" class="form-control" id='kbg' name='kbg' placeholder="KBG" required>
            </div>           
            <div class="form-group">
                <label >Telepon</label>
