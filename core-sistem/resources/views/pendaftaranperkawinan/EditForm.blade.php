    ...
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="row gutters">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <br><h6 class="mb-2 text-primary">Identitas Orang Tua Calon Suami</h6>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <br><h6 class="mb-2 text-primary">Identitas Orang Tua Calon Istri</h6>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label >Nama Lengkap Ayah</label>
                ...
                <!-- LAMPIRAN PASANGAN CALON PENGANTIN -->
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <br><h6 class="mb-2 text-primary">Lampiran Per-Pasangan Calon Pengantin</h6>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                ...
                <!-- HAL LAIN -->
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <br><h6 class="mb-2 text-primary">Hal Lain</h6>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" value="{{$data->ttd_calon_istri}}" id='ttd_calon_istri' name='ttd_calon_istri' onchange="document.getElementById('output33').src = window.URL.createObjectURL(this.files[0])"x>
