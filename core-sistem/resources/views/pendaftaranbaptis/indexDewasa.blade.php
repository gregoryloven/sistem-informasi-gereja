...
<div class="card shadow mb-4">
    <div class="card shadow">
        <div class="card-header py-3">
            Riwayat Pendaftaran Sakramen Baptis Dewasa
        </div>
        <div class="card-body">
            <div class="table-responsive">
...
function detail(id)
{
  $.ajax({
    type:'POST',
    url:'{{ route('pendaftaranbaptis.detailDewasa', substr(app('currentTenant')->domain, 0, strpos(app('currentTenant')->domain, ".localhost")) ) }}',
    data:{'_token':'<?php echo csrf_token() ?>',
          'id':id
         },
    success: function(data){
