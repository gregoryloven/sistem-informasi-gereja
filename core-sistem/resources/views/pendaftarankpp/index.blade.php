        ...
        <div class="table-responsive">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ url('pendaftarankpp/EditForm/'.$d->id) }}" class="btn btn-xs btn-flat btn-warning">Ubah</a>
                    <form role="form" method="POST" class="ml-1"  action="{{ url('pendaftarankpp/'.$d->id) }}">
                        @csrf
                        @method('DELETE')
