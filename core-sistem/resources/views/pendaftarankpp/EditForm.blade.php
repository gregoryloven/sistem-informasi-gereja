    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header py-3">
                Ubah Formulir Pendaftaran Kursus Persiapan Perkawinan
            </div>
            <div class="card-body">
            <form role="form" class="mb-2" method="post" action="{{ url('pendaftarankpp/'.$data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row gutters">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h6 class="mb-2 text-primary">Identitas Calon Suami</h6>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$data->nama_ayah_calon_suami}}" id='nama_ayah_calon_suami' name='nama_ayah_calon_suami' placeholder="Nama Ayah Calon Suami" required>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label >Nama Lengkap Ibu</label>
                        <input type="text" class="form-control" value="{{$data->nama_ibu_calon_suami}}" id='nama_ibu_calon_suami' name='nama_ibu_calon_suami' placeholder="Nama Ibu Calon Suami" required>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        <label >KTP</label>
                        <input type="file" class="form-control" value="{{$data->ktp_calon_suami}}" id='ktp_calon_suami' name='ktp_calon_suami' onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
                        <img id="output" src="{{asset('file_kpp/ktp/'.$data->ktp_calon_suami)}}" width="100px" height="100px">
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" value="{{$data->suratpengantar_lingkungan_calon_suami}}" id='suratpengantar_lingkungan_calon_suami' name='suratpengantar_lingkungan_calon_suami' onchange="document.getElementById('output2').src = window.URL.createObjectURL(this.files[0])">
                        <img id="output2" src="{{asset('file_kpp/suratpengantar_lingkungan/'.$data->suratpengantar_lingkungan_calon_suami)}}" width="100px" height="100px">
                    </div>
                </div>
                @endif
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" value="{{$data->suratpengantar_paroki_calon_suami}}" id='suratpengantar_paroki_calon_suami' name='suratpengantar_paroki_calon_suami' onchange="document.getElementById('output3').src = window.URL.createObjectURL(this.files[0])">
                        <img id="output3" src="{{asset('file_kpp/suratpengantar_paroki/'.$data->suratpengantar_paroki_calon_suami)}}" width="100px" height="100px">
                    </div>
                </div>
                @endif
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label >Nama Lengkap Ayah</label>
                        <input type="text" class="form-control" value="{{$data->nama_ayah_calon_istri}}" id='nama_ayah_calon_istri' name='nama_ayah_calon_istri' placeholder="Nama Ayah Calon Istri" required>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label >Nama Lengkap Ibu</label>
                        <input type="text" class="form-control" value="{{$data->nama_ibu_calon_istri}}" id='nama_ibu_calon_istri' name='nama_ibu_calon_istri' placeholder="Nama Ibu Calon Istri" required>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        <label >KTP</label>
                        <input type="file" class="form-control" value="{{$data->ktp_calon_istri}}" id='ktp_calon_istri' name='ktp_calon_istri' onchange="document.getElementById('output4').src = window.URL.createObjectURL(this.files[0])">
                        <img id="output4" src="{{asset('file_kpp/ktp/'.$data->ktp_calon_istri)}}" width="100px" height="100px">
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        <label >Surat Pengantar Lingkungan</label>
                        <input type="file" class="form-control" value="{{$data->suratpengantar_lingkungan_calon_istri}}" id='suratpengantar_lingkungan_calon_istri' name='suratpengantar_lingkungan_calon_istri' onchange="document.getElementById('output5').src = window.URL.createObjectURL(this.files[0])">
                        <img id="output5" src="{{asset('file_kpp/suratpengantar_lingkungan/'.$data->suratpengantar_lingkungan_calon_istri)}}" width="100px" height="100px">
                    </div>
                </div>
                @endif
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" value="{{$data->suratpengantar_paroki_calon_istri}}" id='suratpengantar_paroki_calon_istri' name='suratpengantar_paroki_calon_istri' onchange="document.getElementById('output6').src = window.URL.createObjectURL(this.files[0])">
                        <img id="output6" src="{{asset('file_kpp/suratpengantar_paroki/'.$data->suratpengantar_paroki_calon_istri)}}" width="100px" height="100px">
                    </div>
                </div>
                @endif
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$data->lokasi}}" id='lokasi' name='lokasi' required readonly>
                    </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        <label >Keterangan Kursus</label>
                        <input type="text" class="form-control" value="{{$data->keterangan_kursus}}" id='keterangan_kursus' name='keterangan_kursus' required readonly>
                    </div>
                </div>
